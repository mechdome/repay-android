...
import com.repay.android.currencypicker.CurrencyPicker;
import com.repay.android.currencypicker.CurrencyPickerListener;
...
public class SettingsFragment extends PreferenceFragment implements CurrencyPickerListener {
...
//		}
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findPreference("currencies_list").setOnPreferenceClickListener(new OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                currencyPicker = CurrencyPicker.newInstance("Select Country");
                currencyPicker.setListener(SettingsFragment.this);
                currencyPicker.show(getFragmentManager(), "COUNTRY_PICKER");
                return true;
            }
        });
    }
    ...
    public void onSelectCountry(String name, String currencySymbol) {
        ...
        editor.putString(PREF_KEY_CURRENCY, currencySymbol);
        editor.apply();
    }
}
