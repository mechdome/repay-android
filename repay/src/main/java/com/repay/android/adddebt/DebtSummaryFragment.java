...
public class DebtSummaryFragment extends DebtFragment implements OnClickListener, OnCheckedChangeListener {
    ...
    public static DebtSummaryFragment newInstance(Debt debt) {
        DebtSummaryFragment debtSummaryFragment = new DebtSummaryFragment();
        Bundle args = new Bundle();
        args.putSerializable("debt", debt);
        debtSummaryFragment.setArguments(args);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (getArguments() != null && getArguments().getSerializable("debt") != null) {
            mDescription.setText(((Debt) getArguments().getSerializable("debt")).getDescription());
        }
...
//        } else {
//            Debt debt = (Debt) getArguments().getSerializable("debt");
//            if (debt.getDebtID() == 3) {
